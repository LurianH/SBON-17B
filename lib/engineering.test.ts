...
describe('Validação', () => {
  ...
  it('permite project_type ausente nos cadastros existentes', () => {expect(projectSchema.parse({municipality: 'Tatuí', segment_type: 'WATER', project_category: 'GENERAL', project_name: 'Projeto'}).project_type).toBeUndefined();});
